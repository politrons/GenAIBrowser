...
from .dspy_program import BrowserAssistant
...
def _extract_prompt_artifact(
    ...
    instructions = (
        ...
        "Answer with concrete, verifiable details from retrieved web evidence and clearly cite URLs."
    )
